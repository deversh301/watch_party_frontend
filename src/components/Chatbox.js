...
export default function Chatbox(props) {
  ...
  const onkeyup = (e) => {
    ...
    if (
      Math.round(Date.now() / 1000) - timingsfor >= 2 ||
      nooftimesithits % 20 == 0
    ) {
  ...
  return (
    <div
      id="chatboxy"
      onClick={clickinghere}
      className="card vertical-scrollable "
    >
      <div
        ...
        <div className="row">
          ...
          <div className="col-6 content_align_right">
            <div className="dropdown">
              ...
              >
                {props.joinedUsers.map((users) => (
                  <Joinedlist username={users.username} />
                ))}
              </ul>
            </div>
          </div>
