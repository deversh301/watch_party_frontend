...
export default function HomeModel(props) {
  ...
  const copyToClipboard = async (e) => {
    ...
    textArea.value =
      window.location.origin + "/?code=" + localStorage.getItem("groupcode");
  ...
  return (
    <>
      <Modal show={props.show} onHide={props.handleClose}>
        ...
        <Modal.Body>
          {props.groupcode} is the joining code for this group. copy and share
          with your friends for joining.
        </Modal.Body>
        <Modal.Footer>
          <Button
            variant="secondary"
            className={setingclass}
            onClick={(e) => {
              copyToClipboard(e);
            }}
          >
